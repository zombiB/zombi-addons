...
try:
    ...
    Memorise = StorageServer.StorageServer("smsmDownloader")
except:
...
class cDownloadProgressBar(threading.Thread):
    ...
    def _StartDownload(self): 
        ...
        #self.Memorise.set("smsmDownloaderWorking", "1")
        ...
        cConfig().showInfo('smsm', 'Téléchargement Démarré')
        ...
        while not (self.processIsCanceled or diag.isFinished()):
            ...
            #if self.Memorise.get("smsmDownloaderWorking") == "0":
        ...
        Memorise.unlock("smsmDownloaderLock")
    ...
    def run(self):
        ...
        if not Memorise.lock("smsmDownloaderLock"):
    ...
    def StopAll(self):
        ...
        #self.Memorise.set("smsmDownloaderWorking", "0")
...
class cDownload:  
    ...
    def isDownloading(self):
        ...
        if not Memorise.get('smsmDownloaderLock'):
            return False
        return True
    ...
    def CleanDownloadList(self):
        ...
        try:
            cDb().clean_download()
            cConfig().showInfo('smsm', 'Liste mise a jour')
            #cConfig().update()
        except:
            pass
    ...
    def DelFile(self):
        ...
        if (oDialog == 1):
            ...
            try:
                ...
                xbmcvfs.delete(path)
                cConfig().showInfo('smsm', 'Fichier supprimé')
                cConfig().update()
            except:
                cConfig().showInfo('smsm', 'Erreur, fichier non supprimable')

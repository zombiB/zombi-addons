...
class cHome:
	...
	oGui.addDir(SITE_IDENTIFIER, 'showSport', '[COLOR '+color_sports+']'+cConfig().getlanguage(30113)+'[/COLOR]', 'sport.png', oOutputParameterHandler)
    ...
    def showSport(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'sportNews', '[COLOR '+color_videos+']'+cConfig().getlanguage(30113)+' ('+cConfig().getlanguage(30101)+')[/COLOR]', 'news.png', oOutputParameterHandler)

        # Affiche les Genres Vidéos
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'sportGenres', '[COLOR '+color_videos+']'+cConfig().getlanguage(30113)+' ('+cConfig().getlanguage(30105)+')[/COLOR]', 'genres.png', oOutputParameterHandler)

        # Affiche les Sources Vidéos
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'sportSports', '[COLOR '+color_videos+']'+cConfig().getlanguage(30138)+'[/COLOR]', 'host.png', oOutputParameterHandler)
    ...
    def showMovies(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'movieAr', '[COLOR '+color_films+']'+cConfig().getlanguage(30120)+' ('+cConfig().getlanguage(30107)+')[/COLOR]', 'films_news.png', oOutputParameterHandler)

        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'movieEn', '[COLOR '+color_films+']'+cConfig().getlanguage(30120)+' ('+cConfig().getlanguage(30108)+')[/COLOR]', 'films_views.png', oOutputParameterHandler)

        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'movieAnime', '[COLOR '+color_films+']'+cConfig().getlanguage(30120)+' ('+cConfig().getlanguage(30160)+')[/COLOR]', 'films_hd.png', oOutputParameterHandler)

        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'movieHi', '[COLOR '+color_films+']'+cConfig().getlanguage(30120)+' ('+cConfig().getlanguage(30103)+')[/COLOR]', 'films_comments.png', oOutputParameterHandler)

        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'movieTurk', '[COLOR '+color_films+']'+cConfig().getlanguage(30120)+' ('+cConfig().getlanguage(30109)+')[/COLOR]', 'films_notes.png', oOutputParameterHandler)

        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'movieAsian', '[COLOR '+color_films+']'+cConfig().getlanguage(30120)+' ('+cConfig().getlanguage(30104)+')[/COLOR]', 'films_notes.png', oOutputParameterHandler)
    ...
    def showSeries(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'serieAr', '[COLOR '+color_series+']'+cConfig().getlanguage(30121)+' ('+cConfig().getlanguage(30107)+')[/COLOR]', 'series_vf.png', oOutputParameterHandler)

        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'serieEn', '[COLOR '+color_series+']'+cConfig().getlanguage(30121)+' ('+cConfig().getlanguage(30108)+')[/COLOR]', 'series_vostfr.png', oOutputParameterHandler)

        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'serieAsia', '[COLOR '+color_series+']'+cConfig().getlanguage(30121)+' ('+cConfig().getlanguage(30110)+')[/COLOR]', 'series_vostfr.png', oOutputParameterHandler)
	
	oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'serieTr', '[COLOR '+color_series+']'+cConfig().getlanguage(30121)+' ('+cConfig().getlanguage(30109)+')[/COLOR]', 'series_vostfr.png', oOutputParameterHandler)
    ...
    def showAnimes(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'animMovies', '[COLOR '+color_anims+']'+cConfig().getlanguage(30122)+' ('+cConfig().getlanguage(30120)+')[/COLOR]', 'animes_vf.png', oOutputParameterHandler)
    ...
    def showReplay(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'replayIslamic', '[COLOR '+color_replaytvs+']'+cConfig().getlanguage(30139)+'[/COLOR]', 'replay_host.png', oOutputParameterHandler)
    ...
    def movieAr(self):
        self.__callpluging('MOVIE_AR', color_films, 'films_news.png')

    def movieEn(self):
        self.__callpluging('MOVIE_EN', color_films, 'films_views.png')

    def movieHi(self):
        self.__callpluging('MOVIE_HI', color_films, 'films_hd.png')

    def movieAnime(self):
        self.__callpluging('MOVIE_ANIME', color_films, 'films_comments.png')

    def movieTurk(self):
        self.__callpluging('MOVIE_TURK', color_films, 'films_notes.png')

    def movieAsian(self):
        self.__callpluging('MOVIE_ASIAN', color_films, 'films_notes.png')
    ...
    def serieAr(self):
        self.__callpluging('SERIE_AR', color_series, 'series_vf.png')

    def serieEn(self):
        self.__callpluging('SERIE_EN', color_series, 'series_vostfr.png')
		
    def serieTr(self):
        self.__callpluging('SERIE_TR', color_series, 'series_vostfr.png')
		
    def serieAsia(self):
        self.__callpluging('SERIE_ASIA', color_series, 'series_vostfr.png')
    ...
    def sportNews(self):
        self.__callpluging('SPORT_NEWS', color_sports, 'sport.png')

    def sportGenres(self):
        self.__callpluging('SPORT_GENRES', color_sports, 'sport.png')
    ...
    def replayIslamic(self):
        self.__callpluging('REPLAYTV_ISLAM', color_videos, 'news.png')

...
class cLibrary:
    ...
    def setLibrary(self):
        ...
        sLink = 'plugin://plugin.video.smsm/?function=play&site=cHosterGui&sFileName=' + sFileName + '&sMediaUrl=' + sMediaUrl + '&sHosterIdentifier=' + sHosterIdentifier
    ...
    def getLibrary_old(self):
        ...
        xbmc.executebuiltin("Container.Update(special://userdata/addon_data/plugin.video.smsm/)")

...
SITE_IDENTIFIER = 'anyanime'
SITE_NAME = 'anyanime'
SITE_DESC = 'arabic anime'
 
URL_MAIN = 'http://www.anyanime.com/'


ANIM_NEWS = ('http://www.anyanime.com/', 'showMovies')
ANIM_MOVIES = ('http://www.anyanime.com/list_anime_online/', 'showAnimes')
...
def showAnimes(sSearch = ''):
    ...
    sPattern = '<div class="anime-block"><div class="anime-type"><a href=".+?" rel="tag">.+?</a></div><img.+?src="([^<]+)" class="attachment-anime_list size-anime_list wp-post-image" alt=""/> <a href="([^<]+)" rel=".+?"><div class="anime-title-list">([^<]+)</div>'
...
def showInfo():
    ...
    sPattern = '<a href="([^<]+)">([^<]+)<i class="fa fa-long-arrow-down"'
...
def showEpisodes():
    ...
    sPattern = '<a href="([^<]+)" rel="dofollow">.+?<span class="ep_name">([^<]+)</span> <span class="ep_nums">([^<]+)</span></li>'
...
def showLink():
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            siteUrl = 'http://www.anyanime.com/api/v/watch.php?server=gd&video='+sPage
            sTitle = 'server Gdrive'

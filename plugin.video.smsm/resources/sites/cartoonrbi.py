...
ANIM_MOVIES = ('http://www.cartoon3rbi.net/films.html', 'showMovies')
ANIM_NEWS = ('http://www.cartoon3rbi.net/cats.html', 'showSeries')
...
#([^<]+)(.+?)
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addMisc(SITE_IDENTIFIER, 'showHosters', aEntry[2], '', sThumbnail, aEntry[2], oOutputParameterHandler)
...
def showSeries(sSearch = ''):
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addMisc(SITE_IDENTIFIER, 'showEps', aEntry[1], '', sThumbnail, aEntry[1], oOutputParameterHandler)
...
def showEps():
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            oGui.addMovie(SITE_IDENTIFIER, 'showHosters', aEntry[1], '', sThumbnail, aEntry[2], oOutputParameterHandler)

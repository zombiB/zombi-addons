...
class cFav:
    ...
    def getFavourites(self):
        ...
        sTitle = '[COLOR khaki]You ve bookmarked %s  videos[/COLOR]' % (len(row))
        ...
        oGui.addDir(SITE_IDENTIFIER, 'getFav', 'All (' + str(compt[5]) + ')', 'mark.png', oOutputParameterHandler)
    ...
    def setFavorite(self):
        ...
        if int(oInputParameterHandler.getValue('sCat')) < 1:
            cConfig().showInfo('Error','Impossble to get it bookmarked')
            return

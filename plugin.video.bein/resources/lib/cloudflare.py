...
#Cookie path
#C:\Users\BRIX\AppData\Roaming\Kodi\userdata\addon_data\plugin.video.bein\
...
PathCache = xbmc.translatePath(xbmcaddon.Addon('plugin.video.bein').getAddonInfo("profile"))

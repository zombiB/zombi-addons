...
class GestionCookie():
    #PathCache = xbmc.translatePath(xbmcaddon.Addon('plugin.video.matrix').getAddonInfo('profile')).decode('utf-8')
    PathCache = 'special://userdata/addon_data/plugin.video.matrix'
...
class cConfig():
    ...
    # def __init__(self):
        ...
        # self.__sFileDB = os.path.join(self.__oCache,'matrix.db').decode('utf-8')
...
def WindowsBoxes(sTitle, sFileName, num, year = ''):
    ...
    #path = xbmc.translatePath('special://home/addons/plugin.video.matrix').decode('utf-8')

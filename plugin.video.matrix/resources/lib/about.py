...
#sLibrary = xbmc.translatePath('special://home/addons/plugin.video.matrix').decode('utf-8')
...
class cAbout:
    ...
    def getUpdate(self):
        ...
        if (service_time):
            ...
            if (time_now - time_service > time_sleep):
                ...
                sUrl = 'https://api.github.com/repos/zombiB/zombi-addons/releases/latest'
    ...
    def TextBoxes(self, anounce):
        ...
        xbmc.sleep(100)
        # set heading
        win.getControl(1).setLabel('matrix mise à jour')

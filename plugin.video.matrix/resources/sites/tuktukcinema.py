...
MOVIE_EN = (URL_MAIN + '/category/movies-33/%D8%A7%D9%81%D9%84%D8%A7%D9%85-%D8%A7%D8%AC%D9%86%D8%A8%D9%8A', 'showMovies')
...
SERIE_EN = (URL_MAIN + '/sercat/مسلسلات-اجنبي/ ', 'showSeries')


SERIE_HEND = (URL_MAIN + '/sercat/مسلسلات-هندي/', 'showSeries')
SERIE_ASIA = (URL_MAIN + '/sercat/مسلسلات-أسيوي/', 'showSeries')
SERIE_TR = (URL_MAIN + '/sercat/مسلسلات-تركي/', 'showSeries')
...
def showMovies(sSearch = ''):
    ...
    # (.+?) .+? ([^<]+)   
    sPattern = '<div class="Block--Item"><a href="([^<]+)" title="([^<]+)">.+?<img src="([^<]+)" alt='
    aResult = oParser.parse(sHtmlContent, sPattern)
    if aResult[0] :
        total = len(aResult[1])
  ...
  # ([^<]+) .+?
        sPattern = '<a class="page-numbers" href="([^<]+)">(.+?)</a>'
...
def showHosters():
    ...
    sPattern = '<div class="watch--area "><li data-link="([^<]+)"class=.+?<span>(.+?).+?</span></li>'
    oParser = cParser()
    aResult = oParser.parse(sHtmlContent, sPattern)

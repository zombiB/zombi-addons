...
SITE_IDENTIFIER = 'yacinetv'
SITE_NAME = 'yacinetv'
SITE_DESC = 'arabic vod'
 
URL_MAIN = siteManager().getUrlMain(SITE_IDENTIFIER)

SPORT_LIVE = ('https://ar.yacine-tv.com/home-3/', 'showMovies')
...
# ([^<]+) .+? (.+?)
    ...
    sPattern = '<a target="_blank" href="(.+?)">.+?title="(.+?)" src=.+?title="(.+?)" src='
...
def showLive():
    ...
    if aResult[0] is True:
        ...
        for aEntry in aResult[1]:
            ...
            hdr = {'User-Agent' : 'Mozilla/5.0 (iPad; CPU OS 13_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/87.0.4280.77 Mobile/15E148 Safari/604.1','referer' : 'https://yacine-app.tv/'}
            St=requests.Session()

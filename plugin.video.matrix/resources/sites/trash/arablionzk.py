...
SITE_IDENTIFIER = 'arablionzk'
SITE_NAME = 'arablionz [COLOR gold] 4K [/COLOR]'
SITE_DESC = 'arabic vod'
 
URL_MAIN = 'https://arblionz.com'


MOVIE_EN = ('https://arblionz.com/search?s=4k', 'showMovies')
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            if '/download/' in siteUrl:
                oGui.addMisc(SITE_IDENTIFIER, 'showServer1', sTitle, '', sThumbnail, sInfo, oOutputParameterHandler)
            else:

...
KID_MOVIES = ('https://www.katkoute.com/watch/category.php?cat=aflam-cartoon-arabic', 'showMovies')
KID_CARTOON = ('https://www.katkoute.com/watch/index.php', 'showSeries')
...
#([^<]+).+?
    sPattern = '<a href="([^<]+)" title="([^<]+)"><div class="pm-video-labels hidden-xs">.+?<img src="https://www.katkoute.com/watch/templates/echo/img/echo-lzld.png" alt=".+?" data-echo="([^<]+)" class="img-responsive">'
...
def showLink1():
    ...
    sHtmlContent = oRequestHandler.request()
     ...
     #(.+?)([^<]+)
    sPattern = '<iframe src="([^<]+)" width="([^<]+)" height="100%" frameborder="0" scrolling="no" allowfullscreen></iframe>'
...
def showLink():
    ...
    sHtmlContent = oRequestHandler.request();
    #recup du lien mp4
    sPattern = 'file: "([^<]+)",type:"video/mp4",label: "720p HD"}'

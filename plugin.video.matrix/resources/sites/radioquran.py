...
def showSeries(sSearch = ''):
 ...
 # ([^<]+) .+?
    ...
    sPattern = '<h3 class="text-center" style="color:#540217;"><strong><em>([^<]+)</em></strong></h3>.+?<div><img src="([^<]+)" class="article_image" style="width:100%; height: 300px; text-align: center;"></div>.+?<p class="pull-right">([^<]+)</p>.+?<div><a class="btn btn-default" style="width: 100%;" href="([^<]+)"> مشاهدة الحلقات  </a></div>'
...
def showEpisodes():
    ...
    sHtmlContent = oRequestHandler.request()
     # (.+?) ([^<]+) .+?
    sPattern = '<div class ="pull-right">([^<]+)</div>.+?<a href="([^<]+)" style='

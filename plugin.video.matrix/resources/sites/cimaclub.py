...
RAMADAN_SERIES = ('http://cimaclub.com/category/%D9%85%D8%B3%D9%84%D8%B3%D9%84%D8%A7%D8%AA-%D8%B9%D8%B1%D8%A8%D9%8A/%D8%B1%D9%85%D8%B6%D8%A7%D9%86-2019/', 'showSerie')
...
ANIM_NEWS = ('http://cimaclub.com/category/%D8%A7%D9%86%D9%8A%D9%85%D9%8A%D8%B4%D9%86/%D9%85%D8%B3%D9%84%D8%B3%D9%84%D8%A7%D8%AA-%D8%A7%D9%86%D9%8A%D9%85%D9%8A%D8%B4%D9%86/', 'showSerie')
...
def showMovies(sSearch = ''):
    ...
    sPattern = '<div class="content-box"><a href="([^<]+)" class="image" data-src="([^<]+)"></a>.+?<span class="badge primary">([^<]+)</span><a href=".+?"><h3>([^<]+)</h3>'
...
def showSerie(sSearch = ''):
    ...
    sPattern = '<div class="content-box"><a href="([^<]+)" class="image" data-src="([^<]+)"></a>.+?><h3>([^<]+)</h3></a>'
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            if 'seasons' in sUrl:
                ...
                oGui.addMovie(SITE_IDENTIFIER, 'showServer', aEntry[1], '', sThumbnail, '', oOutputParameterHandler)
 ...
 # ([^<]+) .+?
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            oOutputParameterHandler.addParameter('sMovieTitle', sTitle)
            oOutputParameterHandler.addParameter('sThumbnail', sThumbnail)
            oGui.addTV(SITE_IDENTIFIER, 'showServer1', sTitle, '', sThumbnail, sInfo, oOutputParameterHandler)
